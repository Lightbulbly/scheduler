...
export default function InterviewerList (props) {
  ...
  const renderInterviewerList = interviewers.map((interviewer)=> <InterviewerListItem key={interviewer.id} name={interviewer.name} avatar={interviewer.avatar} setInterviewer={()=>{onChange(interviewer.id)}} selected={interviewer.id === value} /> )
